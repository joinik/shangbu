...
// 用户注册服务
func (service *Userservice) Registers(ctx context.Context) serializer.Response {
	code := e.SUCCESS
...
>>>>>>> 7f04f11 (地址查询，完成)
	...
	// if service.Mobile == "" || service.Age == 0 ||
	// 	service.Business == 0 || service.Introduce == "" ||
